 ...
 */
export async function getDerivedOrigin(): Promise<string> {
 ...
 */
export async function fetchLogoUrl(logoType: LogoType): Promise<string | null> {
  try {
 ...
 */
export async function fetchOgMetadata(): Promise<OgMetadata | null> {
  try {
    const origin = await getDerivedOrigin();
